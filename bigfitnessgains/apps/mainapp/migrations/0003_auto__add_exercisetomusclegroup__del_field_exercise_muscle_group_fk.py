...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mainapp_exercisetomusclegroup', (
            ...
            ('exercise_fk', self.gf('django.db.models.fields.related.ForeignKey')(default=76, to=orm['mainapp.Exercise'])),
            ('muscle_group_fk', self.gf('django.db.models.fields.related.ForeignKey')(default=15, to=orm['mainapp.MuscleGroup'])),
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mainapp_exercise', 'muscle_group_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=15, to=orm['mainapp.MuscleGroup']),
                      keep_default=False)
    ...
    models = {
        ...
        u'mainapp.exercisetomusclegroup': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'exercise_fk': ('django.db.models.fields.related.ForeignKey', [], {'default': '76', 'to': u"orm['mainapp.Exercise']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_primary': ('django.db.models.fields.BooleanField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'muscle_group_fk': ('django.db.models.fields.related.ForeignKey', [], {'default': '15', 'to': u"orm['mainapp.MuscleGroup']"})
        },
