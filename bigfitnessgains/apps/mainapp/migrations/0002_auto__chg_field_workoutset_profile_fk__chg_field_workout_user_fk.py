...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkoutSet.profile_fk'
        db.alter_column(u'mainapp_workoutset', 'profile_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Workout.user_fk'
        db.alter_column(u'mainapp_workout', 'user_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'WorkoutSet.profile_fk'
        db.alter_column(u'mainapp_workoutset', 'profile_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.UserProfile']))

        # Changing field 'Workout.user_fk'
        db.alter_column(u'mainapp_workout', 'user_fk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.UserProfile']))
