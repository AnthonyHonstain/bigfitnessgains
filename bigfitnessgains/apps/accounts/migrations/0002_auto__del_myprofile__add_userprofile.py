...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('location_country', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('fitness_focus', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('spirit_animal', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'fitness_focus': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_country': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
